...
class RainAreas:
    ...
    def complete_procedure(self, max_dist, n, eps, az):
        polyline, ray = self.ray_polyline_projection(max_dist, n, eps, az)
...
if __name__ == '__main__':
    ...
    areas.add_squere_polygon(1, 1, 0.5, 10, '1')
    areas.add_squere_polygon(0, 0, 0.3, 5, '2')
    #arr = areas.grid_procedure()
    polyline, ray = areas.ray_polyline_projection(1000, 10, 5, 45)
    true_ints = areas.complete_procedure(1000, 10, 5, 45)
